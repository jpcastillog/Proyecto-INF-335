...
def get(hashtag, limit=1000):
    ...
    for d in dates:
        ...
        file_name = f'./temp_files/{hashtag}-{d}.csv'
        get_twitts(hashtag=hashtag, file_name=file_name, since_date=since_date, until_date=until_date, custom=custom_retrieve,limit=limit)
